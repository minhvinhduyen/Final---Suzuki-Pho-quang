...
import AppointmentSchedule from './components/common/AppointmentSchedule';
import VehicleArrival from './components/common/VehicleArrival';
import TimelineLegend from './components/common/TimelineLegend';
